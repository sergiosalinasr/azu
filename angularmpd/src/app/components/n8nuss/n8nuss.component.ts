...
@Component({
  selector: 'app-chat',
  templateUrl: './n8nuss.component.html',
  styleUrls: ['./n8nuss.component.css']
})
export class N8nussComponent {
  userInput: string = '';
  sessionId: string = 'uss';
  ...
  ngOnInit(): void {
    ...
    console.log("En n8nuss/ngOnInit id_cliente=" + this.id_Cliente);
