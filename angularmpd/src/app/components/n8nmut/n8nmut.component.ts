...
@Component({
  selector: 'app-chat',
  templateUrl: './n8nmut.component.html',
  styleUrls: ['./n8nmut.component.css']
})
export class N8nmutComponent {
  userInput: string = '';
  sessionId: string = 'mutual';
  ...
  ngOnInit(): void {
    ...
    console.log("En n8nmut/ngOnInit id_cliente=" + this.id_Cliente);
  ...
  sendMessage() {
    ...
    this.n8nService.postn8nmutchat(payload).subscribe({
              next: (res) => {
